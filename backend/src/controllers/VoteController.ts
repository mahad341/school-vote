...
export class VoteController {
   ...
   */
  static async getMyVotes(req: Request, res: Response) {
    try {
   ...
   */
  static async getVotesByPost(req: Request, res: Response) {
    try {
   ...
   */
  static async getVotesByCandidate(req: Request, res: Response) {
    try {
   ...
   */
  static async verifyVote(req: Request, res: Response) {
    try {
      const { id } = req.params;
   ...
   */
  static async invalidateVote(req: Request, res: Response) {
    try {
      const { id } = req.params;
   ...
   */
  static async getVotingStats(req: Request, res: Response) {
    try {
      const service = new VoteService();
   ...
   */
  static async verifyVoteByHash(req: Request, res: Response) {
    try {
