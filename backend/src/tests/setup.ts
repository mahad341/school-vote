...
declare global {
  var testUtils: {
    ...
    createTestPost: (postData: any) => Promise<any>;
    createTestCandidate: (candidateData: any) => Promise<any>;
